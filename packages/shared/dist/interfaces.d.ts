import type { ProfessionalWithProfile, Conversation, Message, MessageWithSender, MaterialList, MaterialItem, StoreOfferWithStore, Order, OrderWithStore, Work, WorkFull, AvailabilitySlot, Visit, VisitFull } from './types';
...
export interface IAvailabilityRepository {
    ...
    replaceAll(professionalId: string, slots: {
        weekday: number;
        start_time: string;
        end_time: string;
